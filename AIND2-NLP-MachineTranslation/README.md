# Introduction
In this notebook, build a deep neural network that functions as part of an end-to-end machine translation pipeline. NMT pipeline will accept English text as input and return the French translation.
...
## neural machine translation (NMT) notebooks
- `helper.py`
